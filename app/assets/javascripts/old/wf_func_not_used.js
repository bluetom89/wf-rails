...
function addConn(id, pid, label, source, target) {
...
function jsLoadBoard($html_data) {
    ...
    for (var i = 0; i < saved_item_arr.length; i++) {
        ...
        instance.makeSource($('#board #item_'+i), {
                            filter:".ep",
                            anchor:"Continuous",
                            isSource: true,
                            isTarget: true,
                            connector:[ "StateMachine", {curviness:25} ],
        ...
        instance.makeTarget($('#board #item_'+i), {anchor:"Continuous"});
...
function editConn(c) {
                ...
                success : function(data) {
                    ...
                    $('#pop_up #submit'). click(function () { 
                        ...
                        c.setPaintStyle( {strokeStyle: $('#pop_up #bg').val()} );
